                    ...
                    <div className="center_AdminUpdateCourse__container">
                        ...
                        <div className="center_content_AdminUpdateCourse">
                            ...
                            <div className="center_content_AdminUpdateCourse__find">
                                <form action="">
                                    <label className="upCourse_label" htmlFor="idCourse">ID khóa học</label>
                                    <input type="text" name="id" id="Up_idCourse" placeholder="Nhập ID khóa học cần sửa" />
                                    <div className="btn_updateCourse_find">
                                        <input type="submit" className="btn_search_updateCourse" value="Tìm"/>
                                    </div>
                                </form>
                            </div>
